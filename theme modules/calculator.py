...
def sub():
    ...
    res = num1 - num2
    answer_entry.delete(0, "end")  # Удаляет предыдуший элемент  в "Ответ"
    answer_entry.insert(0, res)  # добавляет элемент в итог "Ответ"
...
# Кнопки операций
button_add = tk.Button(window, text='+', width=2, height=2, command=add)  # переменная хранящего  наш виджет в виде кнопки   I
